...
namespace eval job {
	proc run {} {
		# validate crew(s) (::job::m__crews)
		set x [string trim $::job::m__crews]
		if {$x == ""} {
			printf "What is your partition(s)?"
			return
		}
...
#		printf $x
		...
		if {$chunk == "genRIB" && $word == "m_RIB_FORCED"} {
			set content $::alfred::gen_RIB::m__RIB_FORCED
		} else {
